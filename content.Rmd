...
In the course, students will learn about common **computational methods in Communication Science**. They will learn how to use the statistical programming environment R to a) import various data formats as well as gather data from online sources, b) transform and wrangle data to get it ready for analysis, c) perform text classification and analysis (including dictionary approaches, machine learning approaches, as well as large language models such as GPT), d) perform statistical methods in independent research projects.

<img src="slides/img/text_analysis_fundamentals/Slide1.png"/>

<span style="font-size:0.75em;">General text classification pipeline</span>
...
-   have knowledge about recent approaches natural language processing (incl. machine learning, large language models...)
