---
title: "Word Embeddings and Transformers (complete)"
...
```{r, echo = F}
#save(results, file = "R_text_LLM_word-embeddings-and-transformers_complete_files/results.RData")
load("R_text_LLM_word-embeddings-and-transformers_complete_files/results.RData")
results
```
...
```{r, echo = F}
#save(map_results, file = "R_text_LLM_word-embeddings-and-transformers_complete_files/map_results.RData")
load("R_text_LLM_word-embeddings-and-transformers_complete_files/map_results.RData")
map_results
```
...
```{r, echo = F}
#save(map_results2, file = "R_text_LLM_word-embeddings-and-transformers_complete_files/map_results2.RData")
load("R_text_LLM_word-embeddings-and-transformers_complete_files/map_results2.RData")
```
