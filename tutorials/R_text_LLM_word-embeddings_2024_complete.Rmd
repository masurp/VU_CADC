...
```{r, echo=F, message=F}
knitr::opts_chunk$set(echo = TRUE, results = TRUE, eval = T, message = FALSE, warning = FALSE, fig.keep = "none")
library(printr)
```
...
We are going to use the package collections `tidyverse`, `tidytext` and `tidymodels` (and the extension . 
