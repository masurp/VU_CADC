...
- They probably explored more paramters, we will only investigate the following:
...
The best combination seems to be 12 nodes in the hidden layer, a penalty of 0.01 and 1000 epochs. 
