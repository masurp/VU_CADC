...
## TIMELINE OF NATURAL LANGUAGE PROCESSING {transition="slide"}
...
## A very small example {auto-animate="true"}
...
## A very simple example: Dictionary approach x
...
## A very simple example: Dictionary approach {auto-animate="true"}
