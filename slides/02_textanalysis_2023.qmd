...
subtitle: "Week 2: Basics of Automated Text Analysis and Dictionary Approaches"
...
hcandersen_en |>
  ...
  geom_col(width = .5) +
  geom_text(aes(label = n), color = "white", nudge_y = -180, size = 5) +
...
## How to present text numerically?
