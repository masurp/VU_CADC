...
_Image Source: https://www.leansigmacorporation.com/box-plot-with-minitab/_

---

# Relationships between numeric variables: Scatterplot
...
data %>% 
  ggplot( aes(x=GrLivArea, y=SalePrice/1000)) +
    ...
    geom_smooth(se = F, linetype = "dashed", color = "black") +
...
- Understanding this grammar is a powerful for creating great visualizations
...
![](https://miro.medium.com/max/2000/1*mcLnnVdHNg-ikDbHJfHDNA.png)
_Sarkar, 2018_
...
- However, there are many caveats and sometimes a classic table does the job

- The appropriate graph is always determined by the *type of data* and the *context*/*research question*

- In the next practical session, we will learn how to produce nice figures in R!
