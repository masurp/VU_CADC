...
left_join(
  ...
  tibble(years = c(1:100),
         decades = rep(c("white", "grey"), each = 10, times = 5))) %>%
  ggplot(aes(x = weeks, y = years)) +
  geom_point(shape = 15, aes(color = life)) +
  scale_x_continuous(breaks = seq(0, 52, by = 4)) +
  scale_y_continuous(breaks = seq(0, 100, by = 10)) +
  geom_point(aes(x = 17, y = 26), shape = 1, size = 3, color = "blue") +
  geom_point(aes(x = 25, y = 80), shape = 1, size = 3) +
  geom_point(aes(x = 10, y = 83), shape = 1, size = 3) +
  theme_ipsum() +
  theme(legend.position = "none",
        axis.title.x = element_text(),
        axis.title.y = element_text())  +
  labs(x = "Weeks of the year", y = "Age in years")
```
]
...
- Black dots: Life expectancy for men and women respectively

- Blue circle: Einstein publishes his theory of special relativity

- Isn't this a very powerful visualizations?
