...
<p style="font-size:0.75em;">_Hilbert & Lopez, 2011_</p>
...
<p style="font-size:0.75em;">_Hvitfeldt & Silge, 2021, chap. 1_</p>
...
<p style="font-size:0.75em;">_van Atteveldt, Welbers, & Van der Velden, 2019_</p>
...
flowchart LR
    ...
    D --> H(Document-Term-Feature-Matrix)
    E --> H
    F --> H
    G --> H
```
...
```
<br>
<p style="font-size:0.75em;">_Manning, Raghavan, and Schütze 2008_</p>
...
<p style="font-size:0.75em;">_Hvitfeldt & Silge, 2021, chap. 2.2_</p>
...
<p style="font-size:0.75em;">_Boumans & Trilling, 2016_</p>
:::
::::
...
textplot_wordcloud(trump_dtm, max_words = 35, color = "red")
```
:::
::: {.column width="5%"}
:::
...
textplot_wordcloud(obama_dtm, max_words = 35, color = "blue")
```
...
<p style="font-size:0.75em;">_Mellado et al., 2021_</p>
...
<p style="font-size:0.75em;">_Heidenreich et al., 2019_</p>
...
- Computed sentiment for each document by calculating as the sum of the scores for all words bearing positive sentiment (Pi) minus the sum of all scores from negative words (Ni), divided by the number of words (Wi). 
...
- <p style="font-size:0.75em;">Mellado, C., Hallin, D., Cárcamo, L. Alfaro, R. ... & Ramos, A. (2021) Sourcing Pandemic News: A Cross-National Computational Analysis of Mainstream Media Coverage of COVID-19 on Facebook, Twitter, and Instagram. Digital Journalism, 9(9), 1271-1295, https://doi.org/10.1080/21670811.2021.1942114
...
Name and explain two disadvantages of dictionary approaches. <br>
_(4 points, 2 points for correctly naming two disadvantages and 2 points for correctly explaining them)_
