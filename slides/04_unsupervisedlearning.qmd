...
1. Xou would choose one or more topics to write about, for example 70% healthcare and 30% economy. 
...
- Draw random topic proportions $\theta$
...
- How do we determine such parameters?
...
- Text preprocessing is more important for topic modelling than for other machine learning approaches
...
- We see for example, that there is a high probability of the text 7 being about topic 3 (astrophysics): if we look at the abstract of text 7, this seems to confirm the model!
...
- So how can we at least determine what a good number of topics is?
...
p <- data.frame(k = c(3,6,12,24,48,96), perplexity = NA)
...
![](img/günther_table1_full.png)
## Evolution of topics over time

![](img/günther_fig1.png)


## Type of media researched over time

![](img/günther_fig4.png)
