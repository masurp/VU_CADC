...
[Demo](http://topicmodels.west.uni-koblenz.de/ckling/tmt/restaurant.html?parameters=3,2,1,5)
...
- Gibbs sampling refers to a Markov chain Monte Carlo (MCMC) algorithm for obtaining a sequence of observations which are approximated from a specified multivariate probability distribution from which we cannot sample directly
...
- I understand that this sounds complicated and we won't dive deeper into this topic. 

- If you are interested in how this works in detail, check out the blog post ["LDA under the hood"](http://brooksandrew.github.io/simpleblog/articles/latent-dirichlet-allocation-under-the-hood/) by A. Brook! 
