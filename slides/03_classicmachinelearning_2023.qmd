...
<center>![Source: van Atteveldt et al., 2021](img/lingo.png){width="75%"}</center>
...
-  The following figure depicts two data that can be group by two dimensions (here, I show only two dimensions because it is difficult to imagine or illustrate space in greater than two dimensions)
...
-   Just like a brain uses a network of interconnected cells called "neurons" to provide fast learning cabilities, ANN uses a network of artifical neurons or nodes to solves learning tasks

![](https://miro.medium.com/v2/resize:fit:850/1*30YDnisanIYRHpC-L2Br-g.png)

## Architecture of a neural network

-   ![](img/neuralnetwork.png){style="float: right; padding-left: 40px;" width="350"}Inspired by human brain (but abstracted to mathematical model)

-   Each 'neuron' is a linear model with activation function: <br><br>$y = f(w_1x_1 + … + w_nx_n)$<br><br>

-   Activation functions: logistic, linear, block, tanh, elu, sigmoid...
...
-   ![](img/neuralnetwork2.png){style="float: right; padding-left: 40px;" width="370"}Simple model cannot combine features
...
![](https://lawtomated.com/wp-content/uploads/2019/04/MLvsDL.png){width="60%"}
