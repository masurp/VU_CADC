...
- Field of Social Science that uses algorithmic tools and large/unstructured data tounderstand human/social behaviour 

- Computational methods as “microscope”: methods are not the goal, but contribute to theoretical development 
...
- Measurement / DV: sentiment of posts by user 
...
- What’s cool?
    ...
    - actual behaviour measured as well as self-report measures
...
**Office Hours:** Tuesdays (3-5pm) and Thursdays (10-12am)
...
- Hybrid format (you can follow via Zoom)
...
D. The problem was not problematic ethically.  
