...
My name is Philipp Masur, I am an Assistant Professor for Persuasive Communication.


---

```{r, eval = F}
# Getting the mpg data set (classic data set for illustrations)
...
# Change color palette and rotate labels
bar_chart + 
...
x <- rnorm(1000, 5, 2.5)
m <- rep(c(1,0), 500)
y <- 6 + 3*x + 2.5*m + 3*(x*m) + rnorm(1000, 7, 12.6)
data <- data.frame(homework = x, parental_mediation = m, exam = y) %>%
  as.tibble
...
- **Cycle 1:** Data Wrangling And Data Visualization
    ...
    - Data wrangling and data visualizations
...
- **Cycle 2:** Text Analysis and Machine Learning
    ...
    - Supervised text analysis I
    - Supervised text analysis II
...
- A 12-minute talk (including appropriate slides) in which you:
