...
- Are women underrepresented in TV?
- How many likes to certain post get?
...
The recent acceleration in the use of computational methods for communication
...
**Question:** Do you think these studies are problematic?
...
In the third cycle, students will be assigned to small working groups in which they independently conduct a research project. A final presentation will be graded per group (**20% of the final grade**).
...
Students are required to hand in the slides and analyses beforehand (Deadline: 19th of December 2021 at 12:00). 
