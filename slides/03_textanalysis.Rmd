...
- General procedure
    ...
    - Produce validation scores, e.g., correlation between manual and automated coding, precision, recall...
...
- Again Accuracy: procentual agreement between algorithm and coder
